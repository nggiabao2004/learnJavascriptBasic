...
//1
//2
//(Do không có Catch của Reject nên phải thực hiện finally
//    và báo lỗi: "vì gọi reject nhưung không có catch)
//Done
//(Số 3 không được in ra do bị lỗi Reject đã chặn lại quá trình)
